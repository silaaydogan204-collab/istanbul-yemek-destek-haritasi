...
export default function LandingPage({ onStart }: LandingPageProps) {
  const handleContact = () => {
    window.location.href = "mailto:silanuraydogan@gmail.com?subject=İstYemek%20Dayanışma%20Haritası%20Geri%20Bildirim&body=Merhaba,%20proje%20hakkında%20geri%20bildirim%20paylaşmak%20istiyorum.";
  };
      ...
      <nav className="sticky top-4 z-50 px-6 max-w-7xl mx-auto h-16 flex items-center justify-between bg-white/80 backdrop-blur-md border border-orange-100 rounded-2xl shadow-lg mt-4">
        ...
        <div className="flex items-center space-x-1 sm:space-x-8 text-xs sm:text-sm font-bold text-slate-600">
          ...
          <button 
            ...
            className="hidden md:flex items-center gap-2 bg-orange-500 text-white px-5 py-2.5 rounded-full hover:bg-orange-600 shadow-md transition-all active:scale-95 cursor-pointer border-none"
          >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="flex flex-wrap gap-4 md:justify-end">
              <button 
                onClick={handleContact}
                className="bg-white/10 hover:bg-white/20 px-8 py-4 rounded-2xl font-bold flex items-center gap-3 transition-all border border-white/5 cursor-pointer text-white"
              >
